...
const Fleet = ({ setCarSelection }) => {
  ...
  const cars = [
    ...
    { name: 'Innova / Ertiga', price: 15, desc: 'Ideal for families and groups. Comfortable 6+1 seater with AC.', img: 'https://picsum.photos/seed/innova-crysta-suv/600/400.jpg', bestValue: true, cap: 6, bag: 3 },
